...
export default function Settings() {
  ...
  return (
    ...
    <div>
      <div className="text-transparent select-none flex items-center" id="settings">
        Settings
      </div>
      ...
      <svg width="30" height="30"  viewBox="0 0 25 25" fill='white' xmlns="http://www.w3.org/2000/svg" className="inline-block mr-3 -mt-1">
        ...
        <div className="relative md:w-1/2 xx:w-4/5 inset-x-0 h-2/3 flex rounded-lg border bg-gradient-to-tr from-[#2e2b5285] to-[#08021b81] backdrop-blur-sm border-[#ffffff69] mx-auto mt-4 overflow-y-auto overflow-x-hidden">
          <div className="w-full">
            ...
            <div className="text-center margin pb-3">
                ...
                <br/><br/>
                <textarea
                  className="mt-3 border border-gray-700 hover:border-white bg-transparent rounded-lg p-2 font-normal duration-200 text-gray-400 hover:text-white"
                  id="basePrompt"
                  value={basePrompt}
