  ...
  return (
    <div className="h-auto" id="settings">
      ...
      <svg 
        ...
        Settings</h1>
        <div className="relative lg:w-4/6  xx:w-4/5 inset-x-0 h-2/3 flex rounded-lg border bg-gradient-to-tr from-[#2e2b5285] to-[#08021b81] backdrop-blur-sm border-white border-opacity-40 hover:border-opacity-80 duration-1000 mx-auto mt-4 overflow-y-auto overflow-x-hidden">
