  ...
  return (
    <div className="w-full h-[65px] fixed top-0 shadow-lg shadow-[#000000]/50 bg-[#03001417] backdrop-blur-md z-40">
      <div className="flex justify-between items-center bg-[#03001417] shadow-lg h-[65px] px-4 md:px-0">
        ...
        >
          <Image src="/MySourceAI-w.png" alt="logo" width={40} height={40} />
          <span className="ml-2 hidden md:block text-2xl font-light">MySourceAI</span>
        </a>
        
        <nav className="absolute left-1/2 transform -translate-x-1/2 hidden lg:flex">
          <div className="flex items-center h-auto border border-white border-opacity-40 hover:border-opacity-80 duration-1000 bg-[#0300145e] px-[20px] py-[10px] rounded-lg text-gray-200">
            <a href="#ai-chat" className="cursor-default flex items-center text-white opacity-100 hover:opacity-75 hover:scale-105 font-semibold duration-200 mx-8">
              <img src="/MySourceAI-w.png" alt="AIChat Icon" className="w-5 h-5 mr-2"/>
              AI Chat
            </a>
            <a href="#sources" className="cursor-default font-semibold text-white opacity-100 hover:opacity-75 hover:scale-105 duration-200 mx-8">
            ...
            <a href="#settings" className="cursor-default font-semibold text-white opacity-100 hover:opacity-75 hover:scale-105 duration-200 mx-8">
            <svg viewBox="0 0 25 25" fill='white' xmlns="http://www.w3.org/2000/svg" className="inline-block mr-3 -mt-1 w-5 h-5 animate-spin-slow">
